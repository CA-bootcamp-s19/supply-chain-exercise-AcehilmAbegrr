...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  modifier isOwner (address _address) {
    require(owner == _address, 'caller of this function is not the owner');
    _;
  }
  ...
  modifier forSale(uint _sku) {
    require(items[_sku].state == State.ForSale, 'item is not listed for sale');
    _;
  }
  ...
  modifier received (uint _sku) {
    require(items[_sku].state == State.Received, 'item has not been recieved');
    _;
  }
